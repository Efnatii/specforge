...
const FALLBACK_PATHS = {
  ...
  copy: ["M9 9h11v11H9z", "M4 4h11v11H4z"],
  clipboard: ["M8 2h8v4H8z", "M6 4H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-1"],
  minus: ["M5 12h14"],
  "zoom-in": ["M10 10v6", "M7 13h6", "M21 21l-6-6", "M11 17a6 6 0 1 1 0-12 6 6 0 0 1 0 12"],
  "zoom-out": ["M7 13h6", "M21 21l-6-6", "M11 17a6 6 0 1 1 0-12 6 6 0 0 1 0 12"],
  file: ["M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z", "M14 2v6h6"],
  pencil: ["M4 20h4l10-10-4-4L4 16v4z"],
  pin: ["M12 2l4 4-2 2v6l2 2H8l2-2V8L8 6z", "M12 16v6"],
  panel: ["M3 4h18v16H3z", "M8 4v16"],
  tree: ["M12 3v18", "M12 8h6", "M12 13h6", "M12 18h6", "M6 8h2", "M6 13h2", "M6 18h2"],
  tasks: ["M9 11l3 3 6-6", "M5 5h14", "M5 19h14"],
...
function probeSpriteAvailability() {
  ...
  window.fetch(SPRITE_URL, { cache: "force-cache" }).then((response) => {
    if (!response.ok) {
